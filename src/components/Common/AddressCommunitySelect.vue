...
// 1 api 接口
import { listAddressCommunity } from "@/api/address/addressCommunity.js";
...
const props = defineProps({
  ...
  placeholder: { type: String, default: "大区编码/大区名称" },
...
const fetchData = async (query = "") => {
  ...
  try {
    ...
    // 4 发起请求
    const response = await listAddressCommunity(queryParams);
