<template>
   <div class="app-container">
      ...
      <el-table class="table-container" ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
