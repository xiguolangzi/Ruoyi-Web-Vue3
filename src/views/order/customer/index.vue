...
const { order_customer_type } = proxy.useDict('order_customer_type');
...
const getCustomerLevelName = (levelId) => {
  console.log("customerLevelList -- level----------------",levelId);
  console.log("customerLevelList -- level----------------",customerLevelList.value);
