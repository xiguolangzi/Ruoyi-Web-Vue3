  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange" resizable  ref="customerTable" @expand-change="handleExpandChange2" row-key="customerId">
