<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="供应商地址" align="center" prop="address" min-width="200" show-overflow-tooltip />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['order:supplier:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
