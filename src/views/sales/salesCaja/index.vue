  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="收银机名称" prop="cajaName">
        <el-input v-model="queryParams.cajaName" placeholder="请输入收银机名称" clearable @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd"
          v-hasPermi="['sales:salesCaja:add']">新增设备</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate"
          v-hasPermi="['sales:salesCaja:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['sales:salesCaja:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport"
          v-hasPermi="['sales:salesCaja:export']">导出</el-button>
      </el-col>
      <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table class="table-container" v-loading="loading" :data="salesCajaList"
      ...
      <el-form ref="salesCajaRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="唯一标识" prop="macAddress">
          <el-input v-model="form.macAddress" disabled>
            <template #suffix>
              <el-button type="primary" icon="Refresh" @click="handleFreshMacAddress" style="margin-right: -10px;" />
            </template>
          </el-input>
        </el-form-item>
        <el-form-item label="收银机名称" prop="cajaName">
          <el-input v-model="form.cajaName" placeholder="请输入收银机名称" type="textarea" maxlength="30" show-word-limit
            :rows="1" />
        </el-form-item>
        <el-form-item label="设备状态" prop="cajaStatus">
