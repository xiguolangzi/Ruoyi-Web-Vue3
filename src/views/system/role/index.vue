<template>
   <div class="app-container">
      ...
      <!-- 表格数据 -->
      <el-table class="table-container" v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
...
const dataScopeOptions = ref([
  ...
  { value: "3", label: "仅本公司数据权限" },
  { value: "4", label: "本公司及下属公司的数据权限" },
